  ...
  Widget build(BuildContext context) {
    return ElevatedButton(
      ...
      style: ElevatedButton.styleFrom(
        ...
        backgroundColor: backgroundColor ?? AppColors.deepPurple, // 기본 배경색
        textStyle: TextStyle( color: textColor ?? AppColors.textWhite), // 기본 텍스트 색상
        minimumSize: minimumSize ?? const Size(100, 40), // 기본 버튼 크기
        elevation: elevation ?? 2.0, // 기본 그림자 높이
      ).copyWith(
        backgroundColor: MaterialStateProperty.resolveWith(
              (states) => backgroundColor ?? AppColors.textWhite,
        ),
      ),
